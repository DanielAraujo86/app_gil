                      ...
                      children: [
                        DragTarget(                          
                          builder: (context, candidateItems, rejectedItems) {
                            return Container(
                                child: Image.asset('assets/imagens/LixeiraMetall.png'),
                                width: 80,
                                height: 80);
                          },
                          onAccept: (item) {
                        ...
                        DragTarget(
                          builder: (context, candidateItems, rejectedItems) {
                            return Container(
                                child: Image.asset('assets/imagens/LixeiraPlasticoo.png'),
                                width: 80,
                                height: 80);
                          },
                          onAccept: (item) {
                        ...
                        DragTarget(
                          builder: (context, candidateItems, rejectedItems) {
                            return Container(
                                child: Image.asset('assets/imagens/LixeiraVidroo.png'),
                                width: 80,
                                height: 80);
                          },
                          onAccept: (item) {
                        ...
                        DragTarget(
                          builder: (context, candidateItems, rejectedItems) {
                            return Container(
                                child: Image.asset('assets/imagens/LixeiraPapel.png'),
                                width: 80,
                                height: 80);
                          },
                          onAccept: (item) {
